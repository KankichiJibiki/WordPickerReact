...
const FlashCard = ({ wordList }) => {
    ...
    let badgeStyle =
        'bg-yellow-100 text-yellow-800 font-medium dark:bg-yellow-900 dark:text-yellow-300';
    if (!usersAudioExists) {
        badgeStyle =
    ...
    return (
        <Card bg="bg-teal-100 mb-2">
            <div className="p-2">
                <div className="mb-3 border-b border-teal-600">
                        ...
                        <div className="inline">
                            {
                                <div className="text-gray-500 w-auto mb-1">
                                    ...
                                    <span>{wordTypes[wordList.type]}</span>
                                </div>
                            }
                        </div>
                        <h3 className="text-xl font-bold">{wordList.word}</h3>
                        <div className="flex">
                            <h3 className="text-sm text-gray-500 mr-1">
                                {wordList.pronunciation.all}
                            </h3>
                            <button
                    ...
                    <div className="mb-4">
                        <div className="text-sm mb-2">
                            ...
                            {wordList.definition_en}
                        </div>
                        <div className="text-sm">
                            <span className="font-bold">JP: </span>
                            {wordList.definition_jp}
                        </div>
                    </div>

                    <div className="mb-4">
                        <div className="text-gray-600 text-sm border-b-2">
                            Examples
                        </div>
                    ...
                    <div hidden={isViewAll ? false : true}>
                        ...
                        <div className="mb-4">
                            <div className="text-gray-600 text-sm border-b-2 pb-1">
                                <span className="mr-1">Your audio</span>
                                <span
                                    className={`${badgeStyle} text-xs rounded me-2 px-2.5 py-0.5`}
                                >
                                    {usersAudioExists
                                        ? 'Registered'
                                        : 'Not yet'}
                ...
                <button
                    onClick={() => toggleView((prevState) => !prevState)}
                    className="flex justify-between text-white bg-black text-center hover:bg-gray-700 text-xs p-1 ml-auto rounded-md"
                >
                    <span className="mr-1">{isViewAll ? 'Less' : 'More'}</span>
