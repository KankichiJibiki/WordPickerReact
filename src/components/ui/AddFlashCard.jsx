...
const AddFlashCard = ({
                ...
                .then(
                    (result) => {
                        ...
                        if (scrollToElement != null) {
                            scrollToElement('sampleFlashCard');
                        }
                    },
                    (error) => {
                        console.log(error);
    ...
    const setFlashCard = () => {
        return {
            word: word,
            type: type,
            definition_en: self_enter_en
                ? definition_en
                : definition_en_select[definition_en],
            definition_jp: self_enter_jp
                ? definition_jp
                : definition_jp_select[definition_jp],
    ...
    const setInputCompletion = async (result) => {
        ...
        for (let i = 0; i < MAX_AUTO_COMPLETION; i++) {
            if (result.Results[i] && result.Results[i].Synonyms) {
                setValueToMultiInputHelper(
                    'synonyms',
                    result.Results[i].Synonyms[0],
                    i
                );
            }
        }
                ...
                <div className="bg-white px-6 py-8 mb-4 shadow-md rounded-md border m-4 md:m-0">
                    <form onSubmit={handleSubmit(registerFlashCard)}>
                                    ...
                                    <section className="w-full mx-4">
                                        <div className="mb-4">
                                            <div className="flex mb-2">
                                                ...
                                                <span className="bg-red-100 text-red-800 text-xs font-medium me-2 px-2.5 py-1 rounded-full dark:bg-red-900 dark:text-white">
                                                    必須
                                                </span>
                                            </div>
                                            <input
                                        ...
                                        {hasWord ? (
                                            <div className="flex">
                                                <button
                                                    type="button"
                                                    className="flex hover:bg-gray-300 rounded p-1 mr-2"
                                        ...
                                        <div className="mb-4">
                                            ...
                                            <p className="text-red-500 text-sm mt-1">
                                                {errors.definition_en?.message}
                                            </p>
                                            {!self_enter_en ? (
                                                <button
                                                    className="flex text-sm py-1 px-3 rounded bg-gray-200"
                                                    onClick={backToEnInput}
                                                >
                                                    <span className="mr-1">
                                                        入力に戻す
                                                    </span>
                                        ...
                                        <div className="mb-4">
                                            ...
                                            {!self_enter_jp ? (
                                                ...
                                                <input
                                                    ...
                                                    {...register(
                                                        ...
                                                        {
                                                            required:
                                                                'Japanese definition is required'
                                                        }
                                                    )}
                                                    value={definition_jp}
                                                    onChange={(e) =>
                                            ...
                                            <p className="text-red-500 text-sm mt-1">
                                                {errors.definition_jp?.message}
                                            </p>
                                            {!self_enter_jp ? (
                                                <button
                                                    className="flex text-sm py-1 px-3 rounded bg-gray-200"
                                                    onClick={backToJPInput}
                                                >
                                                    <span className="mr-1">
                                                        入力に戻す
                                                    </span>
                        ...
                        <div className="text-center">
                            <button
                                className="bg-teal-500 text-white font-bold py-2 px-4 rounded hover:bg-teal-400 inline-flex mr-4"
                                type="submit"
                            >
                                <span className="mr-2">Add Flash Card</span>
                                <LuBookUp className="text-2lg mt-0.5" />
                            </button>
                            <button
                                className="text-black bg-gray-300 py-2 px-4 rounded hover:bg-gray-200 "
                                onClick={resetInputs}
                            >
                                Clear
                            </button>
